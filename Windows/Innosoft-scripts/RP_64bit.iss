...
AppId={{967CF638-385C-405D-B9DD-13DCCB2E24FD}
AppName={#MyAppName}
...
SetupIconFile=D:\setups\scripts\RP-logo.ico
OutputBaseFilename=RockPigeon_Build_8-1222-1015
OutputDir=D:\SigmaStream\Installers\RockPigeon\
Compression=lzma
SolidCompression=yes
UninstallDisplayIcon=D:\setups\scripts\RP-logo.ico
...
[Files]
Source: "D:\setups\RockPigeon\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs 
Source: "D:\setups\postgresql-9.6.6-3-windows-x64.exe"; DestDir: "{tmp}"; AfterInstall: RunPostgresInstaller; Flags: deleteafterinstall
...
Filename: "{app}\nssm.exe"; Parameters: "install RockPigeon {app}\server\rockpigeon-server.bat"
Filename: "{app}\nssm.exe"; Parameters: "set RockPigeon Application {app}\server\rockpigeon-server.bat"
Filename: "{app}\nssm.exe"; Parameters: "set RockPigeon AppDirectory {app}\server\"
Filename: "{app}\nssm.exe"; Parameters: "set RockPigeon DisplayName RockPigeon-Server"
Filename: "{app}\nssm.exe"; Parameters: "set RockPigeon Description RockPigeon-Server"
Filename: "{app}\nssm.exe"; Parameters: "set RockPigeon Start SERVICE_AUTO_START"
Filename: "{app}\Tools\postgres\setup-postgres.bat"; StatusMsg: "Setting Up Postgres...";  Flags: runmaximized
