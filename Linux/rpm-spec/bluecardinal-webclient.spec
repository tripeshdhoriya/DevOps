Name:       BlueCardinal-WebClient
Version:    2
Release:    2
Summary:    BlueCardinal-WebClient
...
FOLDER_NAME=bluecardinal-webclient/

# zip -rq $SRCDIR/bluecardinal.zip $SRCDIR/$FOLDER_NAME
tar -zcf $SRCDIR/bluecardinal-webclient.tar $SRCDIR/$FOLDER_NAME
...
ls | grep -v bluecardinal-webclient | xargs rm
...
%files
# /home/sigmastream/bluecardinal/bc_release-1.2.0/
...
if [ ! -d "/home/sigmastream/bcwebclient" ]
    then
        echo -n "[+] Creating application symbolic link..."
        cd /home/sigmastream/
        sudo ln -s /home/sigmastream/bluecardinal/bluecardinal-webclient/ bcwebclient
...
sudo chown -R sigmastream:sigmastream /home/sigmastream/bcwebclient/
sudo chmod -R 755 /home/sigmastream/bluecardinal/
sudo chown sigmastream:sigmastream /etc/init.d/bluecardinal-webclient

# echo "[+] Installing BlueCardinal-WebClient - Done"
echo ""
    echo "###"
    echo "[#] Application name: BlueCardinal-WebClient"
    echo "[#] Application installation path: /home/sigmastream/bluecardinal/bluecardinal-webclient/"
    echo "[#] Application log path: /home/sigmastream/bluecardinal/bluecardinal-webclient/logs/"
...
sudo service bluecardinal-webclient status > /dev/null 2>&1
if [ $? -eq 0 ]
    then 
        echo "[+] Stopping BlueCardinal-WebClient service..."
        sudo service bluecardinal-webclient stop
else    
    echo "[-] BlueCardinal-WebClient service is already stopped."
fi
